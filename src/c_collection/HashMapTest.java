...
class HashMapTest 
{
	...
	*/
	void insertPhoneNo()
	{
		addPhoneNo("가족", "아빠", "010-111-1111");	//해쉬맵/전화번호가 키 값임.
	...
	*/
	...
	{
		phoneBook.put("아빠","010-111-1111");
		phoneBook.put("엄마","010-111-1112");
		phoneBook.put("만득이","010-333-0303");
		phoneBook.put("김사장","010-999-9999");
		phoneBook.put("천득이","010-333-3030");
		phoneBook.put("슈퍼마켓","032-333-0000");
		phoneBook.put("동생","010-111-1113");
		phoneBook.put("치킨집","032-777-9292");
		phoneBook.put("백득이","010-888-8080");
